                    ...
                    {props.user !== undefined &&
                        <div style={{ "textAlign": "right" }}>
                            ...
                            <span style={{ "display": "flex", "gap": "1rem" }}>
                                ...
                                <Link href="/messages">
                                    <Image src={"/svgs/chat.svg"} alt="Messages" sizes="100%" width={0} height={0} style={{
                                        "width": "2rem",
                                        "height": "2rem",
                                        "filter": "invert(1)"
                                    }}></Image>
                                ...
                                <Link href="/users/settings">
                                    <Image src={"/svgs/settings.svg"} alt="Settings" sizes="100%" width={0} height={0} style={{
                                        "width": "2rem",
                                        "height": "2rem",
                                        "filter": "invert(1)"
                                    }}></Image>
                                </Link>
                                {(props.perms & UsergroupFlags.FORUM_MANAGEMENT) == UsergroupFlags.FORUM_MANAGEMENT &&
                                    <Link href="/admin">
                                        <Image src={"/svgs/admin.svg"} alt="Admin Settings" sizes="100%" width={0} height={0} style={{
                                            "width": "2rem",
                                            "height": "2rem",
                                            "filter": "invert(1)"
                                        }}></Image>
